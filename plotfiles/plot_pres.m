...
set(gca,'FontSize',22);
axis([3.25 4.5 75 117]);
title('Pressure in carotis');
grid on;
xlabel('t [s]');
ylabel('p [mmHg]');
...
legend('constr','normal');
set(gca,'FontSize',22);
axis([3.25 4.5 0.75 2.75]);
title('Flow in brachialis');
grid on;
xlabel('t [s]');
ylabel('q [cm^3/s]');
