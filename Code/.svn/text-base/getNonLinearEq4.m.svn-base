...
R_mp_np_half = getFluxVector(A_mp_np_half,Q_mp_np_half,...
    R0_mphalf,P0);
S_mp_np_half = getSourceVector(A_mp_np_half,Q_mp_np_half,...
    R0_mphalf,dR0dX_mphalf,P0);
R2_mp_np_half = R_mp_np_half(2);
S2_mp_np_half = S_mp_np_half(2);
...
% NEW CODE:
%----------
f4  = -a_SolX(3) + Q_m_n - theta*(R2_mp_np_half - R2_mm_np_half) ...
    + gamma*(S2_mp_np_half + S2_mm_np_half);